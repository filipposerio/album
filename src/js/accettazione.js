...
<div class="row">
  <div class="col-lg-3">
  <button id="nuovaAccettazione" class="btn" value="Nuova accettazione"></button>
  </div>
</div>
</br>
...
fnElencoAccettazioniDelPaziente();
});

const fnElencoAccettazioniDelPaziente = () => {
...
const event1 = new CustomEvent('selezioneAccettazioneLat', {bubbles: true, cancelable: true})
let objAccettazione ={}
objAccettazione.idAccettazione =localStorage.idAccettazione;
event1.data=  objAccettazione
document.dispatchEvent( event1 )
fnricetteAccettazione(objAccettazione.idAccettazione);
});
...
const fnricetteAccettazione = (pidAccettazione) => {
  //alert("Elenco ricette accettazione")
  ...
  objAccettazione.idaccettazione = pidAccettazione;
...
const list = ( rows ) => {
  ...
  <button class="btn btn-link btn-sm"  id="nuovaAccettazione" ><h6>NUOVA ACCETTAZIONE</h6></button>
...
`;
  ...
  const html = `
    <button id="nuovaAccettazione" class="btn-xs btn-link" type="button" value="Nuova accettazione"></button>
    <h4 align="center"> Elenco accettazioni</h4>
